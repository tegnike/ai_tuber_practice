        ...
        var F,
          ...
          q = (function (global, env, buffer) {
              ...
              a: do {
                if (
                  ...
                  (m >>> 0 < f >>> 0) |
                    ...
                    (w >>> 0 < o >>> 0) ||
                  !(-1 < (0 | ($ = 0 | c[z >> 2]))) ||
                  ((p = ((n = 0 | c[(Ka + 8) >> 2]) + (u = $ << 2)) | 0),
                  (n >>> 0 < b >>> 0) | (w >>> 0 < n >>> 0)) ||
                  (n >>> 0 < o >>> 0) |
                    (p >>> 0 < b >>> 0) |
                    (w >>> 0 < p >>> 0) ||
                  ((q =
                    ((aa = 0 | c[(ba = (Ka + 12) | 0) >> 2]) + ($ << 6)) | 0),
                  (aa >>> 0 < b >>> 0) | (w >>> 0 < aa >>> 0)) ||
                  (aa >>> 0 < p >>> 0) |
                    (q >>> 0 < b >>> 0) |
                    (w >>> 0 < q >>> 0) ||
                  ((r = ((j = 0 | c[(ua = (Ka + 16) | 0) >> 2]) + u) | 0),
                  (j >>> 0 < b >>> 0) | (w >>> 0 < j >>> 0)) ||
                  (j >>> 0 < q >>> 0) |
                    (r >>> 0 < b >>> 0) |
                    (w >>> 0 < r >>> 0) ||
                  ((s = ((k = 0 | c[(Ca = (Ka + 20) | 0) >> 2]) + u) | 0),
                  (k >>> 0 < b >>> 0) | (w >>> 0 < k >>> 0)) ||
                  (k >>> 0 < r >>> 0) |
                    (s >>> 0 < b >>> 0) |
                    (w >>> 0 < s >>> 0) ||
                  ((t = ((l = 0 | c[(Ea = (Ka + 24) | 0) >> 2]) + u) | 0),
                  (l >>> 0 < b >>> 0) | (w >>> 0 < l >>> 0))
                )
                  Ma = 319
                else {
            ...
            function Oc(a) {
              var b,
                d = 0
              return (a = ((b = 0 | c[(d = 4624) >> 2]) + (0 | a)) | 0) >>> 0 >
                (0 | H()) >>> 0 && 0 == (0 | J(0 | a))
                ? ((c[1026] = 48), -1)
                : ((c[d >> 2] = a), 0 | b)
            }
